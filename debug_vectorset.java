...
public class debug_vectorset {
    public static void main(String[] args) {
        // Test 1: identical vectors - should all be added (IdentityHashMap uses reference equality)
        ...
        System.out.println("v1 == v2: " + (v1 == v2)); // false - different objects
        vs.addElement(v1);
        vs.addElement(v2);
        vs.addElement(v3);
        System.out.println("VectorSet size after adding 3 identical vectors: " + vs.size());
        
        int count = 0;
        for (BinaryVector bv : vs) {
            count++;
            System.out.println("  Vector " + count + ": " + Arrays.toString(bv.getEl()));
        }
